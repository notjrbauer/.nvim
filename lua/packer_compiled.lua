...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-lsp-ts-utils", "null-ls.nvim", "lua-dev.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-z.nvim", "telescope-symbols.nvim", "telescope-dap.nvim", "telescope-project.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'trouble.nvim', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-bufferline.lua', 'nvim-colorizer.lua', 'persistence.nvim', 'nvim-lspconfig'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
