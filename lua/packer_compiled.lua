...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'persistence.nvim', 'nvim-lspconfig', 'nvim-bufferline.lua', 'nvim-colorizer.lua', 'trouble.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
