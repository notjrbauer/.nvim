...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-symbols.nvim", "telescope-z.nvim", "telescope-dap.nvim", "telescope-project.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'trouble.nvim', 'nvim-bufferline.lua', 'nvim-lspconfig', 'persistence.nvim', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'gitsigns.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
