...
_G.packer_plugins = {
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/Users/johnbauer/.local/share/nvim/site/pack/packer/start/impatient.nvim",
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-lspconfig', 'persistence.nvim', 'nvim-colorizer.lua', 'nvim-bufferline.lua', 'trouble.nvim', 'gitsigns.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
