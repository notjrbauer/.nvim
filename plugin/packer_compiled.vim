...
vim.cmd [[au!]]
  -- Filetype lazy-loads
vim.cmd [[au FileType lisp ++once lua require("packer.load")({'vim-sexp', 'compe-conjure', 'conjure'}, { ft = "lisp" }, _G.packer_plugins)]]
vim.cmd [[au FileType scheme ++once lua require("packer.load")({'vim-sexp', 'compe-conjure', 'conjure'}, { ft = "scheme" }, _G.packer_plugins)]]
vim.cmd [[au FileType clojure ++once lua require("packer.load")({'vim-sexp', 'compe-conjure', 'conjure'}, { ft = "clojure" }, _G.packer_plugins)]]
vim.cmd("augroup END")
END
