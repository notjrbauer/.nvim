...
vim.cmd [[au!]]
  -- Filetype lazy-loads
vim.cmd [[au FileType lisp ++once lua require("packer.load")({'compe-conjure', 'vim-sexp', 'conjure'}, { ft = "lisp" }, _G.packer_plugins)]]
vim.cmd [[au FileType scheme ++once lua require("packer.load")({'compe-conjure', 'vim-sexp', 'conjure'}, { ft = "scheme" }, _G.packer_plugins)]]
vim.cmd [[au FileType clojure ++once lua require("packer.load")({'compe-conjure', 'vim-sexp', 'conjure'}, { ft = "clojure" }, _G.packer_plugins)]]
vim.cmd("augroup END")
END
