...
_G.packer_plugins = {
  ...
  ["auto-pairs"] = {
    loaded = true,
    path = "/Users/johnbauer/.config/nvim/pack/packer/start/auto-pairs"
  },
  ["compe-conjure"] = {
  ...
  ["lsp_extensions.nvim"] = {
    config = { "\27LJ\2\n=\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\ractivate\17_.statusline\frequire\0" },
    loaded = true,
  ...
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/Users/johnbauer/.config/nvim/pack/packer/start/nvim-ts-rainbow"
  },
  ["packer.nvim"] = {
    loaded = false,
    needs_bufread = false,
  ...
  ["targets.vim"] = {
    loaded = true,
    path = "/Users/johnbauer/.config/nvim/pack/packer/start/targets.vim"
  },
  tcomment_vim = {
    loaded = true,
  ...
  ["vim-startify"] = {
    loaded = true,
    path = "/Users/johnbauer/.config/nvim/pack/packer/start/vim-startify"
  },
  ["vim-substrata"] = {
    loaded = false,
    needs_bufread = false,
...
try_loadstring("\27LJ\2\n=\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\ractivate\17_.statusline\frequire\0", "config", "lsp_extensions.nvim")
...
vim.cmd [[au!]]
  -- Filetype lazy-loads
vim.cmd [[au FileType clojure ++once lua require("packer.load")({'conjure', 'compe-conjure', 'vim-sexp'}, { ft = "clojure" }, _G.packer_plugins)]]
vim.cmd [[au FileType lisp ++once lua require("packer.load")({'conjure', 'compe-conjure', 'vim-sexp'}, { ft = "lisp" }, _G.packer_plugins)]]
vim.cmd [[au FileType scheme ++once lua require("packer.load")({'conjure', 'compe-conjure', 'vim-sexp'}, { ft = "scheme" }, _G.packer_plugins)]]
vim.cmd("augroup END")
END
