...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    after_files = { "/Users/johnbauer/.local/share/nvim/site/pack/packer/opt/Comment.nvim/after/plugin/Comment.lua" },
  ...
  LuaSnip = {
    ...
    loaded = true,
    path = "/Users/johnbauer/.local/share/nvim/site/pack/packer/start/LuaSnip",
  ...
  ["cmp-nvim-lsp"] = {
    loaded = true,
    path = "/Users/johnbauer/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp",
  ...
  ["filetype.nvim"] = {
    ...
    loaded = true,
    path = "/Users/johnbauer/.local/share/nvim/site/pack/packer/start/filetype.nvim",
  ...
  gruvbox = {
    loaded = true,
    path = "/Users/johnbauer/.local/share/nvim/site/pack/packer/start/gruvbox",
  ...
  ["kanagawa.nvim"] = {
    loaded = true,
    path = "/Users/johnbauer/.local/share/nvim/site/pack/packer/start/kanagawa.nvim",
  ...
  ["lua-dev.nvim"] = {
    loaded = true,
    path = "/Users/johnbauer/.local/share/nvim/site/pack/packer/start/lua-dev.nvim",
  ...
  ["null-ls.nvim"] = {
    loaded = true,
    path = "/Users/johnbauer/.local/share/nvim/site/pack/packer/start/null-ls.nvim",
    url = "https://github.com/jose-elias-alvarez/null-ls.nvim"
  },
  ["nvim-autopairs"] = {
    config = { "\27LJ\2\n0\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\21config.autopairs\frequire\0" },
    loaded = true,
    path = "/Users/johnbauer/.local/share/nvim/site/pack/packer/start/nvim-autopairs",
    url = "https://github.com/windwp/nvim-autopairs"
  },
  ["nvim-cmp"] = {
    config = { "\27LJ\2\n,\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\17config.compe\frequire\0" },
    loaded = true,
    path = "/Users/johnbauer/.local/share/nvim/site/pack/packer/start/nvim-cmp",
  ...
  ["nvim-gps"] = {
    config = { "\27LJ\2\nN\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\1\14separator\v î‚±  \nsetup\rnvim-gps\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/Users/johnbauer/.local/share/nvim/site/pack/packer/opt/nvim-gps",
  ...
  ["nvim-lsp-ts-utils"] = {
    loaded = true,
    path = "/Users/johnbauer/.local/share/nvim/site/pack/packer/start/nvim-lsp-ts-utils",
  ...
  ["nvim-lspconfig"] = {
    ...
    wants = { "null-ls.nvim", "nvim-lsp-ts-utils", "lua-dev.nvim", "cmp-nvim-lsp", "nvim-lsp-installer" }
  },
  ["nvim-spectre"] = {
    loaded = false,
    needs_bufread = false,
  ...
  ["nvim-treesitter-textsubjects"] = {
    loaded = true,
    path = "/Users/johnbauer/.local/share/nvim/site/pack/packer/start/nvim-treesitter-textsubjects",
  ...
  ["telescope.nvim"] = {
    after = { "telescope-symbols.nvim", "telescope-z.nvim", "telescope-project.nvim", "telescope-dap.nvim" },
    commands = { "Telescope" },
  ...
  vimspector = {
    loaded = true,
    path = "/Users/johnbauer/.local/share/nvim/site/pack/packer/start/vimspector",
...
try_loadstring("\27LJ\2\n,\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\17config.compe\frequire\0", "config", "nvim-cmp")
...
vim.cmd [[noremap <silent> <M-`> <cmd>lua require("packer.load")({'toggleterm.nvim'}, { keys = "<lt>M-`>", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'indent-blankline.nvim', 'persistence.nvim', 'nvim-colorizer.lua', 'bufferline.nvim', 'gitsigns.nvim', 'nvim-lspconfig', 'trouble.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
