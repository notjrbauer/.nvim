...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-z.nvim", "telescope-project.nvim", "telescope-symbols.nvim", "telescope-dap.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-bufferline.lua', 'gitsigns.nvim', 'nvim-colorizer.lua', 'trouble.nvim', 'persistence.nvim', 'nvim-lspconfig'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
